                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    @foreach($supplierGroups as $supplierGroup)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" class="bt-switch" name="is_active"  value="1" {{$supplierGroup->is_active===1? "checked": ""}}
                                            ...
                                            <td>
                                                <p class="mb-0">
                                                    <small>修改人 : {{$supplierGroup->member->name}}</small><br>
                                                    <small>最後更新 : {{$supplierGroup->updated_at->diffForHumans()}}</small>
                                                </p>
                                            </td>
                                            <td>
                                ...
                                <div class=""> {{$supplierGroups->links("pagination::bootstrap-4")}}</div>
                            </div>
                        </div>
                    </div>
                </div>
